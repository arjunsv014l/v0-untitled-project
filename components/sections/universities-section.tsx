        ...
        <div className="mt-16 text-center">
          <Link href="/for-universities">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center px-6 py-3 border-2 border-black rounded-full bg-emerald-100 hover:bg-emerald-200 text-emerald-800 font-medium transition-colors"
            >
