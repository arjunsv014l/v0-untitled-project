...
import { Brain, BarChart, Users, Zap, MessageSquare, Sparkles, Target, Award } from "lucide-react"
...
export default function AIAssistantFeature() {
  ...
  const tabContent = {
    social: {
      ...
      image: "/student-communication-skills.png",
    },
    career: {
                ...
                <div className="bg-white border-2 border-black rounded-xl p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                  ...
                  {activeTab === "career" && (
                    <div className="bg-gray-50 border-2 border-black rounded-lg p-4">
                      <div className="flex items-start">
                        <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-black flex-shrink-0">
                          <img src="/smiling-student.png" alt="Student" className="w-full h-full object-cover" />
                        </div>
                        <div className="ml-3">
                          <p className="text-gray-700 italic text-sm">
                  ...
                  {activeTab === "network" && (
                    <div className="bg-gray-50 border-2 border-black rounded-lg p-4">
                      <div className="flex items-start">
                        <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-black flex-shrink-0">
                          <img src="/diverse-student-group.png" alt="Student" className="w-full h-full object-cover" />
                        </div>
                        <div className="ml-3">
                          <p className="text-gray-700 italic text-sm">
